...
def sample_borrowing_event_data() -> Dict[str, Any]:
    ...
    return {
        ...
        "data": ["0x1a0027d1bf86904d1051fe0ca94c39b659135f19504d663d66771a7424ca2eb", "0x49d36570d4e46f48e99674bd3fcc84644ddd6b96f7c741b1562b82f9e004dc7", "0x8ec920c39e9", "0x9184e72a000"],
...
def sample_repayment_event_data() -> Dict[str, Any]:
    ...
    return {
        ...
        "data": ["0x7f121e44b3f446cdcaa28b230546956208d51e96894acc3b482947356bc10ed", "0x7f121e44b3f446cdcaa28b230546956208d51e96894acc3b482947356bc10ed", "0x3fe2b97c1fd336e750087d68b9b867997fd64a2661ff3ca5a7c771641e8e7ac", "0xd60", "0xdaf"],
...
def sample_deposit_event_data() -> Dict[str, Any]:
    ...
    return {
        ...
        "data": ["0x1cfa080d4bbddc206637afad05e5e1abb04da69630f40b2fd9dc578e618ec78", "0x585c32b625999e6e5e78645ff8df7a9001cf5cf3eb6b80ccdd16cb64bd3a34", "0x14839256fce60ba2c"],
        "timestamp": 1712276824,
...
def sample_withdrawal_event_data() -> Dict[str, Any]:
    ...
    return {
        ...
        "data": ["0x49920f8f551060f726e3c8c2fe26e2b39376027450b7672634824bd60c64022", "0x585c32b625999e6e5e78645ff8df7a9001cf5cf3eb6b80ccdd16cb64bd3a34", "0x176b344f2a78c0000"],
...
def sample_collateral_enabled_event_data() -> Dict[str, Any]:
    ...
    return {
        ...
        "data": ["0x54f9574d3029b81e0d64e3267a7b682ab920b57948644de4581f5ceb30351ea", "0xda114221cb83fa859dbdb4c44beeaa0bb37c7537ad5ae66fe5e0efd20e6eb3"],
...
def sample_collateral_disabled_event_data() -> Dict[str, Any]:
    ...
    return {
        ...
        "data": ["0x237be5917e0f4ceba3067af8f11137cc7262b9444fce220183e7fdffe4c1a40", "0x4718f5a0fc34cc1af16a1cdee98ffb20c31f5cd61d6ab07201858f4287c938d"],
